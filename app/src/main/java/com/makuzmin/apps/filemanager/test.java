package makuzmin.apps.filemanager;
...
import com.makuzmin.apps.filemanager.*;
...
public class test {
   ...
   //     if (AndroidEnvironment.SDK < AndroidEnvironment.FROYO) {
     //       return null;
       // }
        ...
        try {
            ...
            Log.d(LOG_TAG, "Unexpected reflection error.", ex);
            return null;
    ...
    public static boolean SUPPORTED = MediaStore.Files.getContentUri("external") !=null; //ContentUriUtil.FILES_URI != null;
    ...
    public test(Context context, File file) {
        this.file = file;
	...
	throws IOException {
        ...
        try {
            ...
            test tmpMediaFile = new test(context, tmpFile);
            tmpMediaFile.delete();
        }
